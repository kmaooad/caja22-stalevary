...
@Component
public class CompetenceCreateHandler implements Handler {

    private final TelegramService telegramService;
    private final ActivityService activityService;

    public CompetenceCreateHandler(TelegramService telegramService, ActivityService activityService) {
    ...
    public void handle(Message message, StateMachine stateMachine) {
        try {
            ...
            stateMachine.setState(message.getChatId(), CompetenceCreate.GET_ACTIVITY_ID);
    ...
    public List<String> getCommands() {
        return List.of("createcompetences");
    }
}
