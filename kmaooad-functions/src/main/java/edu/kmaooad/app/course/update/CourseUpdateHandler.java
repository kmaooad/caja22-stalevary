...
@Component
public class CourseUpdateHandler implements Handler {

    private final TelegramService telegramService;
    private final CourseService courseService;

    public CourseUpdateHandler(TelegramService telegramService, CourseService courseService) {
    ...
    public void handle(Message message, StateMachine stateMachine) {
        try {
            ...
            stateMachine.setState(message.getChatId(), CourseUpdate.GET_ID);
